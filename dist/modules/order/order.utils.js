...
const makePaymentAsyn = (paymetPayload) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        shurjopay.makePayment(paymetPayload, (response) => {
            resolve(response);
        }, (error) => {
            reject(error);
        });
...
exports.orderUtils = { makePaymentAsyn, verifyPaymentAsync };
